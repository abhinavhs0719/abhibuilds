...
const YT_DATA = [
  {
    ...
    thumbnail: null,
    url: SOCIAL_URLS.youtube !== '#' ? SOCIAL_URLS.youtube + '/watch?v=PLACEHOLDER_1' : '#',
    published: "Jun 2026",
  ...
  },
  {
    ...
    thumbnail: null,
    url: SOCIAL_URLS.youtube !== '#' ? SOCIAL_URLS.youtube + '/watch?v=PLACEHOLDER_2' : '#',
    published: "Jun 2026",
    tags: ["HTML", "Tutorial"]
  },
  {
    ...
    thumbnail: null,
    url: SOCIAL_URLS.youtube !== '#' ? SOCIAL_URLS.youtube + '/watch?v=PLACEHOLDER_3' : '#',
    published: "Jun 2026",
    tags: ["HTML", "Projects"]
  }
];
...
const LI_DATA = [
  {
    id: "li-001",
    title: "HTML learning reflections — what actually stuck",
    summary: "Sharing my honest reflections on learning HTML — what concepts clicked, what didn't, and how building real projects accelerated my understanding beyond any tutorial.",
    url: SOCIAL_URLS.linkedin !== '#' ? SOCIAL_URLS.linkedin + '/posts/PLACEHOLDER_1' : '#',
    published: "Jun 2026",
    tags: ["HTML", "Learning"]
  },
  {
    id: "li-002",
    title: "My AI + Web Development learning journey",
    summary: "Documenting how I'm combining web development with AI automation — the tools I'm exploring, the workflows I'm building, and why this combination feels like a superpower.",
    url: SOCIAL_URLS.linkedin !== '#' ? SOCIAL_URLS.linkedin + '/posts/PLACEHOLDER_2' : '#',
    published: "Jun 2026",
    tags: ["AI", "Web Dev"]
  },
  {
    id: "li-003",
    title: "Building in public: 30 days of lessons",
    summary: "Why I decided to build in public, what I've learned after 30 days of sharing my journey, and how accountability has become my secret weapon for consistency.",
    url: SOCIAL_URLS.linkedin !== '#' ? SOCIAL_URLS.linkedin + '/posts/PLACEHOLDER_3' : '#',
    published: "Jun 2026",
  ...
  grid.innerHTML = data.map(v => `
    <a href="${escHtml(v.url)}" target="_blank" rel="noopener" class="content-card" data-type="youtube" aria-label="Watch: ${escHtml(v.title)}">
      <div class="content-thumb">
        <div class="content-thumb-inner">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><polygon points="10 8 15 11 10 14 10 8"/></svg>
        </div>
